...
# DVE full session
# Saved on Tue Jul 17 16:49:17 2018
# Designs open: 1
...
#<Session mode="Full" path="/ws/rakeshku-bgl/fpga/DVEfiles/session.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{34 38} {1436 805}}
...
set HSPane.1 [gui_create_window -type HSPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line true -dock_extent 628]
catch { set Hier.1 [gui_share_window -id ${HSPane.1} -type Hier] }
gui_set_window_pref_key -window ${HSPane.1} -key dock_width -value_type integer -value 628
gui_set_window_pref_key -window ${HSPane.1} -key dock_height -value_type integer -value -1
gui_set_window_pref_key -window ${HSPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 627} {height 477} {dock_state left} {dock_on_new_line true} {child_hier_colhier 497} {child_hier_coltype 130} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 477
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 587} {height 477} {dock_state left} {dock_on_new_line true} {child_data_colvariable 325} {child_data_colvalue 140} {child_data_coltype 146} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Console.1 [gui_create_window -type Console -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 184]
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 1390
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 184
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1402} {height 183} {dock_state bottom} {dock_on_new_line true}}
...
gui_show_window -window ${TopLevel.2} -show_state normal -rect {{18 86} {1483 805}}
...
set _session_group_221 Group6
gui_sg_create "$_session_group_221"
set Group6 "$_session_group_221"

gui_sg_addsignal -group "$_session_group_221" { {packet_parser_top_tb.DUT.loop[0].packet_parser_top.InBus_DataSop} {packet_parser_top_tb.DUT.loop[0].packet_parser_top.InBus_DataEop} {packet_parser_top_tb.DUT.loop[0].packet_parser_top.InBus_DataValid} }

set _session_group_222 Group7
gui_sg_create "$_session_group_222"
set Group7 "$_session_group_222"

gui_sg_addsignal -group "$_session_group_222" { {packet_parser_top_tb.DUT.loop[0].packet_parser_top.word_count} {packet_parser_top_tb.DUT.loop[0].packet_parser_top.state} {packet_parser_top_tb.DUT.loop[0].packet_parser_top.pending_bytes} {packet_parser_top_tb.DUT.loop[0].packet_parser_top.field_found} {packet_parser_top_tb.DUT.loop[0].packet_parser_top.error_offset_or_size} {packet_parser_top_tb.DUT.loop[0].packet_parser_top.byte_valid} {packet_parser_top_tb.DUT.loop[0].packet_parser_top.Rst} {packet_parser_top_tb.DUT.loop[0].packet_parser_top.PARSE} {packet_parser_top_tb.DUT.loop[0].packet_parser_top.OutBus_Valid} {packet_parser_top_tb.DUT.loop[0].packet_parser_top.OutBus_Field} {packet_parser_top_tb.DUT.loop[0].packet_parser_top.InBus_Mod} {packet_parser_top_tb.DUT.loop[0].packet_parser_top.InBus_Data} {packet_parser_top_tb.DUT.loop[0].packet_parser_top.InBus_DataValid} {packet_parser_top_tb.DUT.loop[0].packet_parser_top.InBus_DataSop} {packet_parser_top_tb.DUT.loop[0].packet_parser_top.InBus_DataEop} {packet_parser_top_tb.DUT.loop[0].packet_parser_top.IDLE} {packet_parser_top_tb.DUT.loop[0].packet_parser_top.FIELD_SIZE_MAX} {packet_parser_top_tb.DUT.loop[0].packet_parser_top.FIELD_SIZE} {packet_parser_top_tb.DUT.loop[0].packet_parser_top.FIELD_OFFSET} {packet_parser_top_tb.DUT.loop[0].packet_parser_top.DATA_WIDTH} {packet_parser_top_tb.DUT.loop[0].packet_parser_top.Clk} }
gui_set_radix -radix {decimal} -signals {{V1:packet_parser_top_tb.DUT.loop[0].packet_parser_top.PARSE}}
gui_set_radix -radix {unsigned} -signals {{V1:packet_parser_top_tb.DUT.loop[0].packet_parser_top.PARSE}}
gui_set_radix -radix {decimal} -signals {{V1:packet_parser_top_tb.DUT.loop[0].packet_parser_top.IDLE}}
gui_set_radix -radix {unsigned} -signals {{V1:packet_parser_top_tb.DUT.loop[0].packet_parser_top.IDLE}}
...
set _session_group_224 Group9
gui_sg_create "$_session_group_224"
set Group9 "$_session_group_224"

gui_sg_addsignal -group "$_session_group_224" { packet_parser_top_tb.queue_out packet_parser_top_tb.OutBus_Field_muxed packet_parser_top_tb.InBus_DataSop packet_parser_top_tb.InBus_Mod packet_parser_top_tb.InBus_Data packet_parser_top_tb.InBus_DataValid packet_parser_top_tb.InBus_DataSop packet_parser_top_tb.InBus_DataEop packet_parser_top_tb.OutBus_AllValues_Ready packet_parser_top_tb.OutBus_Valid_muxed packet_parser_top_tb.FIELD_OFFSET packet_parser_top_tb.FIELD_SIZE packet_parser_top_tb.field0 packet_parser_top_tb.field1 packet_parser_top_tb.field2 packet_parser_top_tb.field3 packet_parser_top_tb.push_queue }
...
gui_wv_zoom_timerange -id ${Wave.1} 0 5250410
gui_list_add_group -id ${Wave.1} -after {New Group} {Group9}
gui_list_select -id ${Wave.1} {packet_parser_top_tb.InBus_DataEop }
